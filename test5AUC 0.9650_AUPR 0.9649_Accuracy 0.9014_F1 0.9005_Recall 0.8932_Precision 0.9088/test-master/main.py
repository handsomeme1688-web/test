...
class Config:
    def __init__(self):
        ...
        self.view = 3
        self.sim_topk = 96
        self.semantic_topk = 32
        self.nei_size = [64, 16]
        self.hop = 2
        self.feture_size = 256
        self.edge_feature = 9
        self.atthidden_fea = 128
        self.semantic_hidden = 128
        self.hyperedge_views = 4
        self.hypergraph_mode = 'baseline'
        self.sim_class = 3
        self.md_class = 3
        self.m_num = 853
        self.d_num = 591
        ...
        self.use_semantic_fusion_features = True
        self.num_bags = 1
        self.bag_unlabeled_ratio = 1
        self.bag_confidence_ratios = (0.5, 0.3, 0.2)
